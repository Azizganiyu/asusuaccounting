...
@Component({
  selector: 'app-sale-invoice-record',
  templateUrl: './sale-invoice-record.component.html',
  styleUrls: ['./sale-invoice-record.component.scss']
})
export class SaleInvoiceRecordComponent implements OnInit {
