...
@Component({
  selector: 'app-purchase-invoice-record',
  templateUrl: './purchase-invoice-record.component.html',
  styleUrls: ['./purchase-invoice-record.component.scss']
})
export class PurchaseInvoiceRecordComponent implements OnInit {
