...
@Component({
  selector: 'app-inter-account-record',
  templateUrl: './inter-account-record.component.html',
  styleUrls: ['./inter-account-record.component.scss']
})
export class InterAccountRecordComponent implements OnInit {
